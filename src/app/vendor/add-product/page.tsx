...
export default function AddProduct() {
  ...
  useEffect(() => {
    const fetchVendorData = async () => {
      ...
      try {
        console.log('Fetching vendor data for:', user.emailAddresses[0].emailAddress)
        ...
        if (result.success && result.vendor) {
          ...
          console.log('Vendor data loaded:', result.vendor)
        } else {
          console.error('Vendor not found or error:', result.error)
          // Create a fallback vendor data
          setVendorData({
            _id: 'temp_vendor_id',
    ...
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 flex items-center gap-2">
          ...
          {!vendorData && (
            <span className="ml-4 text-sm bg-yellow-100 text-yellow-800 px-2 py-1 rounded">
              Loading vendor data...
            </span>
          )}
        </h1>
